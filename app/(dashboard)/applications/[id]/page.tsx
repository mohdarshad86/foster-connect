  ...
  return (
    <div className="max-w-3xl space-y-6">
        ...
        <dl className="grid grid-cols-2 gap-x-6 gap-y-4 text-sm">
          ...
          {application.applicantPhone && (
            <div>
              ...
              <dd className="text-slate-800 mt-0.5">{application.applicantPhone}</dd>
            </div>
          )}
          ...
          {application.applicantAddress && (
            <div className="col-span-2">
              ...
              <dd className="text-slate-800 mt-0.5">{application.applicantAddress}</dd>
            </div>
          )}
      ...
      <div className="bg-white rounded-xl border border-slate-200 shadow-sm p-6">
        ...
        {!profile ? (
          <p className="text-sm text-slate-400 italic">No personality profile on file yet.</p>
        ) : (
              ...
              <div className="col-span-2">
                ...
                <dd className="flex flex-wrap gap-1.5">
                  {profile.traits.map((t) => (
                    <span key={t} className="px-2 py-0.5 bg-blue-50 text-blue-700 rounded-full text-xs font-medium">
                      {t}
                    </span>
                  ))}
                </dd>
