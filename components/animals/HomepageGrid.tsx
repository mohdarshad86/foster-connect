...
function matchesSpecies(species: string, filter: SpeciesFilter): boolean {
  ...
  if (filter === "Other") return !["dog", "cat"].includes(species.toLowerCase())
      ...
      <div className="bg-white rounded-xl border border-slate-200 shadow-sm p-4">
        ...
        <div className="flex flex-wrap gap-3">
          ...
          <div className="flex flex-col gap-1">
            <label className="text-xs font-medium text-slate-500">Species</label>
            <select
              value={filters.species}
              onChange={(e) =>
                setFilters((f) => ({ ...f, species: e.target.value as SpeciesFilter }))
              }
          ...
          <div className="flex flex-col gap-1">
            ...
            <input
              ...
              className="w-44 rounded-lg border border-slate-300 px-3 py-1.5 text-sm text-slate-900 bg-white placeholder:text-slate-400 focus:outline-none focus:ring-2 focus:ring-blue-500"
            />
          </div>

          {/* Age range */}
          <div className="flex flex-col gap-1">
            <label className="text-xs font-medium text-slate-500">Age range</label>
            <select
              value={filters.age}
              onChange={(e) =>
            ...
            >
              ...
              <option value="Puppy or Kitten">Puppy or Kitten (&lt;1 yr)</option>
